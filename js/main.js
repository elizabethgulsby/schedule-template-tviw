jQuery(document).ready(function($){
	...
	SchedulePlan.prototype.openModal = function(event) {
		...
		var eventName = event.find('.event-name').html();
		var eventDetails = event.find('.event-details').html();
		...
		this.modalHeader.find('.event-name').html(eventName + eventDetails);
		this.modalHeader.find('.event-date').text(event.find('.event-date').text());
		this.modal.attr('data-event', event.parent().attr('data-event'));


		//update event content for event-info
		...
		if( mq == 'mobile' ) {
			...
			var HeaderBgScaleY = modalHeight/eventHeight,
				BodyBgScaleX = (modalWidth - eventWidth * contextAdjust);
